...
public class MainActivity1 extends ListActivity {
    ...
    private void subscribeStdBy(){
        try {
            this.mPubNub.subscribe("robot-channel", new Callback() {
                @Override
...
*/
                ...
                try {
                    ...
                    mPubNub.publish(callNumStdBy, jsonCall, new Callback() {
                        ...
                        public void successCallback(String channel, Object message) {
                            ...
                            Intent intent = new Intent(MainActivity1.this, VideoChatActivity.class);
    ...
    private void dispatchIncomingCall(String userId){
        ...
        Intent intent = new Intent(MainActivity1.this, IncomingCallActivity.class);
        intent.putExtra(Constants.USER_NAME, username);
